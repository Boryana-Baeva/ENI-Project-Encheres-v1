...
class ArticleVenduDAOJDBCImplTest {
	...
	// L'instruction INSERT est en conflit avec la contrainte FOREIGN KEY "articles_vendus_categories_fk". Le conflit s'est produit dans la base de données "encheres_db", table "dbo.CATEGORIES", column 'no_categorie'.
	@Test
